...
class YourName extends BaseCommand
{
    ...
    function processCommand()
    {
       if ($this->user->status === UserStatusService::ORDER_DESCRIPTION) {
        ...
        $this->getBot()->sendMessageWithKeyboard($this->botUser->getId(), $this->translation->get('what_do_you_want_to_order'), new ReplyKeyboardMarkup([
